function accumulate_precip_wet_season_only(periods, start_DOY, remove_seasonal_cycle)
...
for i = 1:length(good_CA_IDs)
    ...
    % % % % % % %
    % % % % % % %
    % Now remove the summer precip!
    precip_obs(:,121:304) = nan;
    precip_sim(:,121:304) = nan;
    ...
    filename = sprintf('precip_%s_accum_DOY%d_wet_season_only.mat',id,start_DOY);
