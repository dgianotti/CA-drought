function accumulate_LL_wet_season_only(periods, start_DOY, remove_seasonal_cycle)
...
for i = 1:length(good_CA_IDs)
    ...
    filename = sprintf('LL_%s_accum_DOY%d_wet_season_only.mat',id,start_DOY);
