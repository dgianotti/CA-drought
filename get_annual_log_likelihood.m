function [LL, years, occ_frac] = get_annual_log_likelihood(stn_id, data, start_year, normalize_LL)
% The function get_annual_log_likelihood determines the log likelihood of
...
% Outputs are:
%
% LL: an N x 1 vector of log-likelihoods, and
%
...
LL_occ = nansum(LL_occ,2);
LL_int = nansum(LL_int,2);
